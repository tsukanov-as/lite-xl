...
-- The function above is added into the Node class but does not use
-- the 'self' variable.
-- It is like a C++ static method and should be called like:
--
-- Node.copy_position_and_size(dst, src)
--
